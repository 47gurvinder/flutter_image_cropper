...
[![BSD-3-Clause license](https://img.shields.io/badge/license-BSD--3--Clause-blue.svg)](image_cropper/LICENSE)
...
Licensed under the [BSD 3-Clause License](image_cropper/LICENSE). Copyright and attribution from the original project are preserved.
